...
CREATE TABLE STUDENTS_CHECKOUT_BOOKS
(
STUDENT_ID VARCHAR2(10),
ISBN VARCHAR2(10),
LIBRARY_ID VARCHAR2(10) NOT NULL,
...
CREATE TABLE STUDENTS_CHECKOUT_JOURNALS
(
STUDENT_ID VARCHAR2(10),
ISSN VARCHAR2(10),
LIBRARY_ID VARCHAR2(10) NOT NULL,
...
CREATE TABLE STUDENTS_CHECKOUT_CONFERENCE_PAPERS
(
STUDENT_ID VARCHAR2(10),
CONF_PAPER_ID VARCHAR2(10),
LIBRARY_ID VARCHAR2(10) NOT NULL,
...
CREATE TABLE FACULTIES_CHECKOUT_CONFERENCE_PAPERS
(
FACULTY_ID VARCHAR2(10),
CONF_PAPER_ID VARCHAR2(10),
LIBRARY_ID VARCHAR2(10) NOT NULL,
...
CREATE TABLE FACULTIES_CHECKOUT_JOURNALS
(
FACULTY_ID VARCHAR2(10),
ISSN VARCHAR2(10),
LIBRARY_ID VARCHAR2(10) NOT NULL,
ISSUE_DATE TIMESTAMP,
DUE_DATE TIMESTAMP,
PRIMARY KEY (ISSN,LIBDATERARY_ID,FACULTY_ID, ISSUE_DATE),
FOREIGN KEY (ISSN) REFERENCES JOURNALS(ISSN),
FOREIGN KEY (LIBRARY_ID) REFERENCES LIBRARIES (LIBRARY_ID),
FOREIGN KEY (FACULTY_ID) REFERENCES FACULTIES(FACULTY_ID)
);
CREATE TABLE FACULTIES_CHECKOUT_BOOKS
(
FACULTY_ID VARCHAR2(10),
ISBN VARCHAR2(10),
LIBRARY_ID VARCHAR2(10) NOT NULL,
...
CREATE TABLE FACULTIES_CHECKOUT_CAMERAS
(
FACULTY_ID VARCHAR2(10),
CAMERA_ID VARCHAR2(10),
LIBRARY_ID VARCHAR2(10) NOT NULL,
...
CREATE TABLE STUDENTS_CHECKOUT_CAMERAS
(
STUDENT_ID VARCHAR2(10),
CAMERA_ID VARCHAR2(10),
LIBRARY_ID VARCHAR2(10) NOT NULL,
